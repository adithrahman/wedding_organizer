...
if ($auth->isGuest() == true){
  if (isset($_GET['reset'])){
      $dec = $sec->encrypt_decrypt("decrypt", $_POST['reset']);
?>
      ...
      <?php echo $msg; ?>
        ...
        <form method="post" action="update-data.php">
            ...
            <div class="field-wrap">
              <input type="hidden" name="wo" value="<?php echo $_GET['reset'];?>" hidden/>
            </div>
            ...
            <div class="field-wrap">
              <input type="submit" name="submit-rpass" class="button button-block"  value="Submit">
            </div>
