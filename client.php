      ...
      <div class="tab-content">
        ...
        <div id="masuk">
          ...
          <form method="post" action="login.php">
            ...
            <p class="forgot"><a href="rcpass.php">Forgot Password?</a></p>
            ...
            <div class="field-wrap">
              <input type="submit" name="submit-clog" class="button button-block"  value="Masuk">
            </div>
